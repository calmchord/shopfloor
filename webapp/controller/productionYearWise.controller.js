sap.ui.define([
    ...
    "use strict";
    return BaseController.extend("shopfloor.controller.productionYearWise", {
        onInit: function () {
            // Initialize JSONModel for the view
            var oModel = new JSONModel();
            this.getView().setModel(oModel, "productionYearWise");
        ...
        _fetchData: function () {
            ...
            var sEntitySet = "ZFM_PRORD_YEARSet";
            ...
            $.ajax({
                ...
                success: function (oData) {
                    if (oData?.d?.results) {
                        that.getView().getModel("productionYearWise").setData(oData.d.results);
                    } else {
