sap.ui.define([
    ...
    "use strict";
    return BaseController.extend("shopfloor.controller.plannedMonthWise", {
        onInit: function () {
            // Initialize JSONModel for the view
            var oModel = new JSONModel();
            this.getView().setModel(oModel, "plannedMonthWise");
        ...
        _fetchData: function () {
            ...
            var sEntitySet = "ZFM_PLORD_MONTHSet";
            ...
            $.ajax({
                ...
                success: function (oData) {
                    if (oData?.d?.results) {
                        that.getView().getModel("plannedMonthWise").setData(oData.d.results);
                    } else {
